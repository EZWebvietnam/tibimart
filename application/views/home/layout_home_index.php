         ...
         <div id="head">
            ...
            <div class="hotline-head">
               <div class="hotline">
                  ...
                  <span>Phía Nam:</span> <?php echo $about[0]['phone']?>
               </div>
               <div class="opentime">
            ...
            <div class="menu-horizontal">
               <ul>
                  <li id="MenuTopControl1_rptTopMenu2_li_0" class="first">
                     <a id="MenuTopControl1_rptTopMenu2_hplLink_0" title="Trang chủ" href="<?php echo base_url();?>">Trang chủ</a>
                  </li>
                  <li id="MenuTopControl1_rptTopMenu2_li_1">
                     <a id="MenuTopControl1_rptTopMenu2_hplLink_1" title="Giới thiệu" href="<?php echo base_url();?>san-pham">Sản phẩm</a>
                  </li>
                  <li id="MenuTopControl1_rptTopMenu2_li_2">
                     <a id="MenuTopControl1_rptTopMenu2_hplLink_2" title="Tin tức" href="<?php echo base_url();?>hoi-dap">Hỏi đáp</a>
                  </li>
                  <li id="MenuTopControl1_rptTopMenu2_li_3">
                     <a id="MenuTopControl1_rptTopMenu2_hplLink_3" title="Thanh toán và vận chuyển" href="<?php echo base_url();?>huong-dan-thanh-toan">Thanh toán và vận chuyển</a>
                  </li>
                  <li id="MenuTopControl1_rptTopMenu2_li_5">
                     <a id="MenuTopControl1_rptTopMenu2_hplLink_5" title="Liên hệ với chúng tôi" href="<?php echo base_url();?>lien-he">Liên hệ</a>
                  </li>
               </ul>
            </div>
            <div class="search">
                     ...
                     <div id="ContentPlaceHolder1_ctl00_pnlProduct">
                        <div class="module">
                           ...
                           <div class="sanpham_tab">
                              ...
                              <p>
                                 <a id="ContentPlaceHolder1_ctl00_ProductListControl1_rpt1_hplTitle_<?php echo $l_product['id_product']?>" data-tooltip="sticky<?php echo $l_product['id_product']?>" href="<?php echo base_url();?>san-pham/<?php echo $l_product['id_product']?>-<?php echo mb_strtolower(url_title(removesign($l_product['title'])))?>"><?php echo$l_product['title']?></a>
                              </p>
                     ...
                     <div id="ContentPlaceHolder1_pnlTooltip">
                        ...
                        <div id="sticky<?php echo $stick['id_product']?>"  class="atip">
                           ...
                           <div class="contenttool">
                              <div class=tab_content id=chitiet style=display:>
                                 <p><a href=http://www.xeday.vn/products/19/Thang-nhom.aspx><span style=color:#000000;> <?php echo $stick['title']?></span></a></p>
