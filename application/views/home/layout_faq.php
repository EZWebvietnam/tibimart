            ...
            <div class="wraper">
               <div id="large">
                  <ul id="crumbs">
                     ...
                     <li><a href="/c7/tin-tuc.aspx">Tin tức</a></li>
                  </ul>
                  <div class="clear">
                  </div>
                  <div class="module">
                        ...
                        <div style="text-align: right; margin:0">
                           ...
                           <div class="ratinglike">
                              ...
                              <div style="display:none" xmlns:v="http://rdf.data-vocabulary.org/#" typeof="v:Review">
                                 <span property="v:itemreviewed">Tin tức</span> Đánh giá bởi <span property="v:reviewer">
                     ...
                     <div>
                        ...
                        <div id="ContentPlaceHolder1_rptArticleList_div_new_item_0" class="news_item_first news_item_1" style="border-top: medium none;">
                           ...
                           <h2>
                              <span data-ft="{&quot;tn&quot;:&quot;K&quot;}">
							  	<?php echo sub_string(loaibohtmltrongvanban($faq['answer']),100)?>
							  </span>
                           </h2>
                           </p>
                           <p align="right">
