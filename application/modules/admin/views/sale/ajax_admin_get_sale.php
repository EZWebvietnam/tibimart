                  ...
                  <table class="admindata">
                     ...
                     <tr class="row1 ">
                        ...
                        <td><?php echo $product_ref['title']?></td>
						 <td><?php echo $product_ref['title_save']?></td>
						  <td><?php echo sub_string(loaibohtmltrongvanban($product_ref['content_sale']),100);?></td>
                        <td><?php echo $product_ref['percent']?></td>
                        <td><?php echo $product_ref['exp_sale']?></td>
                        <td><?php echo $product_ref['price']-($product_ref['percent']*$product_ref['price'])/100?></td>
                        <td align="center">
