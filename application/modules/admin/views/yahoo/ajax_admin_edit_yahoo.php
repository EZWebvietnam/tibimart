...
<div class="m-pop">
    ...
    <form action="<?php echo base_url(); ?>admin/yahooadmin/edit/<?php echo $yahoo_detail[0]['id']?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="adminform">
        <table class="form" style="width: 1200px;">

            <tr>
                <td class="label">Tên</td>
                <td colspan="3">
                    <input id="title_" type="texbox" name="title" value="<?php echo $yahoo_detail[0]['name']?>"/>
                </td>
            </tr>
             <tr>
                <td class="label">Nick</td>
                <td colspan="3">
                    <input id="nick" type="texbox" name="title" value="<?php echo $yahoo_detail[0]['nick']?>"/>
                </td>
            </tr>
            <tr>
                <td class="label">SDT</td>
                <td colspan="3">
                    <input id="sdt" type="texbox" name="title" value="<?php echo $yahoo_detail[0]['phone']?>"/>
                </td>
            </tr>
