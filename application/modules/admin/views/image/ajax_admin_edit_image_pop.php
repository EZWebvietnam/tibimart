...
<div class="m-pop">
    ...
    <form action="<?php echo base_url(); ?>admin/imageadmin/edit/<?php echo $image_detail[0]['id']?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="adminform">
        <table class="form" style="width: 1200px;">

            <tr>
			<?php 
			$id = $image_detail[0]['id'];
			
			?>
                <td class="label">Link</td>
                <td colspan="3">
                    <input type="text" name="link" id="link" value="<?php echo $image_detail[0]['url']?>"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <input id="userfile" name="userfile" type="button" class="bt100" value="Upload" onClick="fileUpload(this.form,'<?php echo base_url();?>upload/upload_image_slide','upload','<?php echo base_url(); ?>admin/imageadmin/edit/<?php echo $id ?>'); return false;">
                   <div id="upload"></div>
        ...
        $("#adminform").validate({
            ...
            , submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    data: {file:$('#file').val(),url:$('#link').val(),show_popup:1},
