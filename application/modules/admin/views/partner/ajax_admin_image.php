      ...
      <tr>
         <td style="background: #FFF;padding: 5px 5px 5px 5px;" valign="top">
            <table style="width: 100%;">
               <tr>
                  ...
                  <td style="float: right;">
					 ...
					 <div class="addlink"><a href="<?php echo base_url(); ?>admin/partneradmin/addimage" class="add grouped_elements"><span>Thêm đối tác</span></a></div>
                  </td>
               </tr>
            </table>
            <div class="box-content">
               ...
               <form action="<?php echo base_url();?>admin/partneradmin/deletes" method="post" accept-charset="utf-8" id="image_khoahoc">
                  <input type="hidden" id="page" value="0"/>
                  <input type="hidden" id="callback" value="<?php echo base_url();?>admin/partneradmin/list_image"/>
                  <table class="admindata">
                     ...
                     <?php 
                        ...
                        ?>
                     <tr class="row1 ">
                        <td align="center"><input  type="checkbox" name="ar_id[]" value="<?php echo $product_ref['id_partner']?>"></td>
						
                        <td><img src="<?php echo base_url();?>file/uploads/partner/<?php echo $product_ref['image']?>" width="100" height="100"/></td>
                        <td align="center">
                            
                            
                           <a class="delete_record" href="<?php echo base_url();?>admin/partneradmin/delete/<?php echo $product_ref['id_partner']?>" title="Xóa"><img src="<?php echo base_url();?>template/ezwebvietnam/admin_cp/icon/del.png"></a>        
               ...
               <script type="text/javascript">
                  function khachhang(page_no){  
                      load_show();   
                      $.post("<?php echo base_url();?>admin/partneradmin/list_image",{'page_no':page_no},function(data){
                          $("#partner_content").html(data);                                            
                          load_hide();
                      });
                  }
