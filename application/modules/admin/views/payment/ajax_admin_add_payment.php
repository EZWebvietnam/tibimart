...
<div class="m-pop">
    ...
    <form action="<?php echo base_url(); ?>admin/paymentadmin/add" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="adminform">
        <table class="form" style="width: 1200px;">
            ...
            <tr>
                ...
                <td colspan="3">
                    <input id="ten_tk" type="texbox" name="ten_tk" value=""/>
                </td>
            </tr>
            <tr>
                <td class="label">STK</td>
                <td colspan="3">
                    <input id="stk" type="texbox" name="stk" value=""/>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    ...
                    <input id="userfile" name="userfile" type="button" class="bt100" value="Upload" onClick="fileUpload(this.form,'<?php echo base_url();?>upload/do_upload_bank','upload','<?php echo base_url(); ?>admin/paymentadmin/add'); return false;">
                   <div id="upload"></div>
