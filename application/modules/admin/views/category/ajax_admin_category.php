                  ...
                  <table class="admindata">
                     ...
                     <tr class="row1 ">
                        ...
                        <td align="center"><a class="grouped_elements" href="<?php echo base_url();?>admin/categoryadmin/edit/<?php echo $product_ref['id_cate']?>" title="Sửa"><img width="16" height="16" src="<?php echo base_url();?>template/ezwebvietnam/admin_cp/icon/edit.png"></a>
                            <a class="grouped_elements" href="<?php echo base_url();?>admin/categoryadmin/view/<?php echo $product_ref['id_cate']?>" title="Xem chi tiết"><img width="16" height="16" src="<?php echo base_url();?>template/ezwebvietnam/admin_cp/icon/view.png"></a>
