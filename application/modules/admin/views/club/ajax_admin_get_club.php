         ...
         <td style="background: #FFF;padding: 5px 5px 5px 5px;" valign="top">
            ...
            <div class="box-content">
               ...
               <form action="<?php echo base_url();?>admin/clubadmin/deletes" method="post" accept-charset="utf-8" id="admindata_club">
                  ...
                  <input type="hidden" id="callback" value="<?php echo base_url();?>admin/aboutadmin/list_club"/>
                  <table class="admindata">
                     ...
                     <?php 
                        ...
                        ?>
                     <tr class="row1 ">
                        <td align="center"><input  type="checkbox" name="ar_id[]" value="<?php echo $new['id_gioithieu']?>"></td>
                        <td><?php echo sub_string(loaibohtmltrongvanban($new['noidung']),300);?></td>
                        <td align="center"><a class="grouped_elements" href="<?php echo base_url();?>admin/aboutadmin/edit/<?php echo $new['id_gioithieu']?>" title="Sửa"><img width="16" height="16" src="<?php echo base_url();?>template/ezwebvietnam/admin_cp/icon/edit.png"></a>
                        </td>
                     </tr>
                     <?php }?>       
                     <tfoot>
               ...
               <script type="text/javascript">
                  function khachhang(page_no){  
                      load_show();   
                      $.post("<?php echo base_url();?>admin/aboutadmin/list_club",{'page_no':page_no},function(data){
