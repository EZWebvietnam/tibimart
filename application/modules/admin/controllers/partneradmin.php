<?php
class Partneradmin extends MY_Controller
{
	...
	public function list_image()
	{
        ...
        $array_sv = $this->faqmodel->list_image_partner($config['per_page'], $page1);
	...
	public function addimage()
	{
		if($this->input->post())
		{
			...
			if($file!='')
			{
				$data_save = array('image'=>$file,'url'=>$url);
				$id = $this->faqmodel->insert_partner($data_save);
				if($id> 0)
				{
		...
		{
			$this->load->view('partner/ajax_admin_image_pop',$this->data);
		}
	}
