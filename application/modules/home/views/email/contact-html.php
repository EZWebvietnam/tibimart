            ...
            <tbody>
               ...
               <tr style="background:#fff">
                  <td style="color:#444444;border:1px solid #dddddd;padding:0 20px">
                     <p style="font-size:18px;color:#444444;font-weight:bold">Email liên hệ từ Tibimart.com</p>
                     <p>Xin chào !,</p>
                     <p>Bạn nhận được một liên hệ tại TibiMart.com</p>
                     <p>Tên: <?php echo $full_name;?></p>
